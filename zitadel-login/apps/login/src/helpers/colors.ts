...
// ── FORK: design tokens ported from the admin console ────────────────────────
// admin/src/assets/theme.css — zinc palette, near-black primary. These are only
// the *defaults*: a Zitadel label policy (private labeling) still overrides them
// per organization at runtime, which is how per-org branding keeps working.
//
// Shades are derived by computeColors() below: 400 = lighten(6), 500 = base,
// 600 = darken(6). The surfaces that matter resolve to:
//   light — card (400) #ffffff, page (600) #f0f0f0
//   dark  — card (500) #18181b, page (600) #0a0a0b, accent (400) #26262b
// which track admin's --card / --background / --accent.
export const DARK_PRIMARY = "#fafafa"; // admin --primary (dark)
export const PRIMARY = "#18181b"; // admin --primary (light)

export const DARK_WARN = "#f87171"; // admin --danger-fg (dark)
export const WARN = "#dc2626"; // admin --destructive

export const DARK_BACKGROUND = "#18181b";
export const BACKGROUND = "#ffffff";

export const DARK_TEXT = "#fafafa"; // admin --foreground (dark)
export const TEXT = "#09090b"; // admin --foreground (light)
