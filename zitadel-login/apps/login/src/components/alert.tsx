...
// FORK: admin's semantic alert surfaces (--warn-bg/fg/bd for the warning intent
// upstream expressed as yellow, neutral chrome tokens for info) instead of raw
// Tailwind yellow/black-alpha.
const yellow = "border-[var(--ui-warn-bd)] bg-[var(--ui-warn-bg)] text-[var(--ui-warn-fg)]";
const neutral = "border-[var(--ui-border)] bg-[var(--ui-accent)] text-[var(--ui-muted-foreground)]";
