...
export default {
  ...
  theme: {
    extend: {
      ...
      // FORK: admin's --radius* scale (admin/src/assets/theme.css). The theme's
      // "mid" roundness maps card -> rounded-lg, button/input -> rounded-md, so
      // overriding these two lands cards on 10px and controls on 8px like admin.
      borderRadius: {
        sm: "6px",
        md: "8px",
        lg: "10px",
