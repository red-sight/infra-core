...
async function submit() {
  ...
  try {
    ...
    // The org lands unsynced; open its page so the pending state is visible.
    goToOrg(org.id)
  } catch (e) {
    toast({
    ...
    <Card>
      ...
      <div v-else class="table-wrap">
        <table class="table table--rows-clickable">
          ...
          <tbody>
            <tr v-for="o in orgs" :key="o.id" @click="goToOrg(o.id)">
              <td>
                <div class="idcell">
              ...
              <td @click.stop>
                <button class="btn btn--ghost btn--icon btn--sm row-actions" @click="goToOrg(o.id)">
